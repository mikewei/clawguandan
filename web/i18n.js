(function () {
  const messages = {
    en: {
      ...
      debugPlayersDetailTitle: "Players detail",
      debugLatestStateJsonTitle: "Latest state JSON",
      debugJsonEmpty: "No state data yet",
      debugPlayerLine:
        "{seat} | id={playerId} | name={playerName} | type={playerType} | model={playerModel} | ready={ready} | presence={presence} | remaining={remaining} | rank={rank}",
      debugFieldSeat: "seat",
      debugFieldId: "playerId",
      debugFieldName: "playerName",
      debugFieldReady: "ready",
      debugFieldPresence: "presence",
      debugFieldRemaining: "remaining",
      debugFieldRank: "rank",
      debugBoolTrue: "true",
      debugBoolFalse: "false",
      action: "Action",
      pass: "Pass",
      passOverlay: "PASS",
      ...
      submitReturnCard: "Return",
      privateHandHint: "Hand area",
      playSelectedCards: "Play",
      ...
      cheatSheetBtn: "Cheat Sheet",
      cheatSheetTitle: "Cheat Sheet",
      cheatSheetSubtitle: "Quick view of combinations and bomb order (ascending).",
      cheatSheetPatternsTitle: "Ordinary combinations",
      cheatSheetBombsTitle: "Bombs (ascending)",
      cheatSheetBombLine: "#{order} {name}",
      "cheatSheetPattern.single.name": "Single",
      "cheatSheetPattern.single.desc": "One card; compared by level order.",
      "cheatSheetPattern.pair.name": "Pair",
      "cheatSheetPattern.pair.desc": "Two cards of same rank; compared by level order.",
      "cheatSheetPattern.triple.name": "Triple",
      "cheatSheetPattern.triple.desc": "Three cards of same rank; compared by level order.",
      "cheatSheetPattern.fullHouse.name": "Full house",
      "cheatSheetPattern.fullHouse.desc": "Three of a kind plus a pair; compare triple rank.",
      "cheatSheetPattern.straight.name": "Straight",
      "cheatSheetPattern.straight.desc": "Five consecutive cards in natural order (non-flush).",
      "cheatSheetPattern.tube.name": "Tube",
      "cheatSheetPattern.tube.desc": "Three consecutive pairs in natural order.",
      "cheatSheetPattern.plate.name": "Plate",
      "cheatSheetPattern.plate.desc": "Two consecutive triples in natural order.",
      "cheatSheetBomb.bomb4.name": "4-card bomb",
      "cheatSheetBomb.bomb4.desc": "Four cards of same rank.",
      "cheatSheetBomb.bomb5.name": "5-card bomb",
      "cheatSheetBomb.bomb5.desc": "Five cards of same rank.",
      "cheatSheetBomb.straightFlush.name": "Straight flush bomb",
      "cheatSheetBomb.straightFlush.desc": "Five consecutive cards of one suit.",
      "cheatSheetBomb.bomb6.name": "6-card bomb",
      "cheatSheetBomb.bomb6.desc": "Six cards of same rank.",
      "cheatSheetBomb.bomb7.name": "7-card bomb",
      "cheatSheetBomb.bomb7.desc": "Seven cards of same rank.",
      "cheatSheetBomb.bomb8.name": "8-card bomb",
      "cheatSheetBomb.bomb8.desc": "Eight cards of same rank.",
      "cheatSheetBomb.bomb9.name": "9-card bomb",
      "cheatSheetBomb.bomb9.desc": "Eight same-rank cards + one wildcard.",
      "cheatSheetBomb.bomb10.name": "10-card bomb",
      "cheatSheetBomb.bomb10.desc": "Eight same-rank cards + two wildcards.",
      "cheatSheetBomb.fourJoker.name": "Four-joker bomb",
      "cheatSheetBomb.fourJoker.desc": "Two black jokers + two red jokers (highest).",
      avatarMetaLine: "{typeLabel}: {playerType} · {modelLabel}: {playerModel}",
      avatarMetaTypeLabel: "type",
      avatarMetaModelLabel: "model",
      avatarMetaModelNone: "-",
      avatarPlayerTypeHuman: "human",
      avatarPlayerTypeBot: "bot",
      avatarPlayerTypeUnknown: "unknown",
      footerVersion: "Version {ver}",
      footerVersionUnavailable: "Version -",
      confirm: "Confirm",
      cancel: "Cancel",
      close: "Close",
    },
    "zh-CN": {
      ...
      tableHistory: "对局历史",
      debugInfo: "详细状态（调试）",
      debugPlayersDetailTitle: "玩家详细信息",
      debugLatestStateJsonTitle: "最新状态 JSON",
      debugJsonEmpty: "暂无状态数据",
      debugPlayerLine:
        "{seat} | 玩家ID={playerId} | 玩家名={playerName} | 类型={playerType} | 模型={playerModel} | 准备={ready} | 在线状态={presence} | 余牌={remaining} | 名次={rank}",
      debugFieldSeat: "座位",
      debugFieldId: "玩家ID",
      debugFieldName: "玩家名",
      debugFieldReady: "准备",
      debugFieldPresence: "在线状态",
      debugFieldRemaining: "余牌",
      debugFieldRank: "名次",
      debugBoolTrue: "是",
      debugBoolFalse: "否",
      action: "操作",
      ...
      cheatSheetBtn: "速查表",
      cheatSheetTitle: "牌型速查表",
      cheatSheetSubtitle: "快速查看牌型与炸弹档位（升序）。",
      cheatSheetPatternsTitle: "普通牌型",
      cheatSheetBombsTitle: "炸弹（升序）",
      cheatSheetBombLine: "第{order}档：{name}",
      "cheatSheetPattern.single.name": "单张",
      "cheatSheetPattern.single.desc": "单牌；按级牌序比较。",
      "cheatSheetPattern.pair.name": "对子",
      "cheatSheetPattern.pair.desc": "两张同点；按级牌序比较。",
      "cheatSheetPattern.triple.name": "三张",
      "cheatSheetPattern.triple.desc": "三张同点；按级牌序比较。",
      "cheatSheetPattern.fullHouse.name": "三带二（葫芦）",
      "cheatSheetPattern.fullHouse.desc": "三张 + 一对；仅比较三张部分。",
      "cheatSheetPattern.straight.name": "顺子",
      "cheatSheetPattern.straight.desc": "五张自然连续，且不能全同花。",
      "cheatSheetPattern.tube.name": "连对",
      "cheatSheetPattern.tube.desc": "三组自然连续对子。",
      "cheatSheetPattern.plate.name": "钢板",
      "cheatSheetPattern.plate.desc": "两组自然连续三张。",
      "cheatSheetBomb.bomb4.name": "四张炸弹",
      "cheatSheetBomb.bomb4.desc": "四张同点。",
      "cheatSheetBomb.bomb5.name": "五张炸弹",
      "cheatSheetBomb.bomb5.desc": "五张同点。",
      "cheatSheetBomb.straightFlush.name": "同花顺炸",
      "cheatSheetBomb.straightFlush.desc": "同花色五张自然连续。",
      "cheatSheetBomb.bomb6.name": "六张炸弹",
      "cheatSheetBomb.bomb6.desc": "六张同点。",
      "cheatSheetBomb.bomb7.name": "七张炸弹",
      "cheatSheetBomb.bomb7.desc": "七张同点。",
      "cheatSheetBomb.bomb8.name": "八张炸弹",
      "cheatSheetBomb.bomb8.desc": "八张同点。",
      "cheatSheetBomb.bomb9.name": "九张炸弹",
      "cheatSheetBomb.bomb9.desc": "八张同点 + 一张百搭。",
      "cheatSheetBomb.bomb10.name": "十张炸弹",
      "cheatSheetBomb.bomb10.desc": "八张同点 + 两张百搭。",
      "cheatSheetBomb.fourJoker.name": "天王炸",
      "cheatSheetBomb.fourJoker.desc": "两黑鬼 + 两红鬼（最大）。",
      avatarMetaLine: "{typeLabel}: {playerType} · {modelLabel}: {playerModel}",
      avatarMetaTypeLabel: "类型",
      avatarMetaModelLabel: "模型",
      avatarMetaModelNone: "-",
      avatarPlayerTypeHuman: "真人",
      avatarPlayerTypeBot: "机器人",
      avatarPlayerTypeUnknown: "未知",
      footerVersion: "版本 {ver}",
      footerVersionUnavailable: "版本 -",
      confirm: "确认",
      cancel: "取消",
      close: "关闭",
    },
